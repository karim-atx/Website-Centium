...
export const BrowserMockup: React.FC<{
  ...
  <div
    className="w-full max-w-[430px] mx-auto rounded-[16px] overflow-hidden bg-white"
  ...
  >
    ...
    <div data-mock-body className="flex min-h-[196px]">
      <div data-mock-rail className="w-[52px] shrink-0 flex flex-col gap-1.5 py-[9px] px-[7px]" style={{ borderRight: `1px solid ${border}` }}>
